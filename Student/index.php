...
?>
              ...
              <div class="card h-100">
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      <div class="text-xs font-weight-bold text-uppercase mb-1">Section mates</div>
            ...
            <!-- Earnings (Monthly) Card Example -->
             <?php 
$query1=mysqli_query($conn,"select * from tblstudents INNER join tblclass on tblstudents.classId = tblclass.Id where tblstudents.Id = '$_SESSION[userId]'");                       
$class__ = $query1->fetch_assoc();
$class = $class__['className'];
$class_arm = $class__['classArmId'];
              ...
              <div class="card h-100">
                <div class="card-body">
                  <div class="row align-items-center">
                    <div class="col mr-2">
                      <div class="text-xs font-weight-bold text-uppercase mb-1">My class</div>
...
$query1=mysqli_query($conn,"select * from tblstudents INNER join tblclassarms on tblstudents.classArmId = tblclassarms.Id where tblstudents.Id = '$_SESSION[userId]'");                       
$class__ = $query1->fetch_assoc();
$class_arm = $class__['classArmName'];
                ...
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      ...
                      <div class="h5 mb-0 font-weight-bold text-gray-800"><?php echo $class_arm;?></div>
                      <div class="mt-2 mb-0 text-muted text-xs">
                        ...
                        <div class="col-xl-3 col-md-6 mb-4">
                          <div class="card h-100">
                            <div class="card-body">
                              <div class="row no-gutters align-items-center">
                                <div class="col mr-2">
                                  <div class="text-xs font-weight-bold text-uppercase mb-1">Semister</div>
